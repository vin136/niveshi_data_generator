...
# Implements all the algorithmic improvements to Deep_Q_learning since it's orginal publications...
import DeepTrader
import argparse
import numpy as np
...
#CONTAINS ABSTRACIONS TO MAKE IT GYM COMPATIBLE
...
DEFAULT_STOCKS = "data/niveshi_train.csv"
DEFAULT_VAL_STOCKS = "data/niveshi_valid.csv"
...
if __name__ == "__main__":
    ...
    # Bellmann unrolling
    exp_source = DeepTrader.experience.ExperienceSourceFirstLast(env, agent, GAMMA, steps_count=REWARD_STEPS)
    buffer = DeepTrader.experience.ExperienceReplayBuffer(exp_source, REPLAY_SIZE)
